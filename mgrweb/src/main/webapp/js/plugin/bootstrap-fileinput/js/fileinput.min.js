    ...
    t = {
        ...
        constructor: i, _cleanup: function () {
            ...
            a.isClickable && (i = a.isAjaxUpload ? a.$dropZone : a.$preview.find(".file-default-preview"), t.addCss(i, "clickable"), i.attr("tabindex", -1), a._handler(i, "click", function (t) {
                var r = e(t.target);
                e(a.elErrorContainer + ":visible").length || r.parents(".file-preview-thumbnails").length && !r.parents(".file-default-preview").length || (a.$element.trigger("click"), i.blur())
            }))
            ...
            t.isEmpty(o.files) && t.isEmpty(o.val()) || (o.files = null, i = o.closest("form"), a = e(document.createElement("form")), r = e(document.createElement("div")), o.before(r), i.length ? i.after(a) : r.after(a), a.append(o).trigger("reset"), r.before(o).remove(), a.remove())
            ...
            var a, r, n = this, o = n.$element, l = arguments.length > 1, s = n.isAjaxUpload, d = [],
                c = l ? i.originalEvent.dataTransfer.files : o.get(0).files, p = n.filestack.length,
                u = t.isEmpty(o.attr("multiple")), f = u && p > 0, m = 0, v = n._getFileIds(),
                g = function (t, i, a, r) {
                    var o = e.extend(!0, {}, n._getOutData({}, {}, c), {id: a, index: r}),
                        l = {id: a, index: r, file: i, files: c};
                    return s ? n._showUploadError(t, o) : n._showError(t, l)
                }, h = function (e, t) {
                    var i = n.msgFilesTooMany.replace("{m}", t).replace("{n}", e);
                    n.isError = g(i, null, null, null), n.$captionContainer.removeClass("icon-visible"), n._setCaption("", !0), n.$container.removeClass("file-input-new file-input-ajax-new")
                };
            if (n.reader = null, n._resetUpload(), n._hideFileIcon(), n.dropZoneEnabled && n.$container.find(".file-drop-zone ." + n.dropZoneTitleClass).remove(), l) if (n.isAjaxUpload) e.each(c, function (e, t) {
                t && !t.type && void 0 !== t.size && t.size % 4096 === 0 ? m++ : n._filterDuplicate(t, d, v)
            }); else {
                if (d = c, r = d.length, u && r > 1) return void h(r, 1);
                o.files = d
            } else c = i.target && void 0 === i.target.files ? i.target.value ? [{name: i.target.value.replace(/^.+\\/, "")}] : [] : i.target.files || {}, s ? e.each(c, function (e, t) {
                n._filterDuplicate(t, d, v)
            }) : d = c;
            if (t.isEmpty(d) || 0 === d.length) return s || n.clear(), n._showFolderError(m), void n._raise("fileselectnone");
            if (n._resetErrors(), r = d.length, a = n._getFileCount(s ? n.getFileStack().length + r : r), n.maxFileCount > 0 && a > n.maxFileCount) {
                if (!n.autoReplace || r > n.maxFileCount) return void h(n.autoReplace && r > n.maxFileCount ? r : a, n.maxFileCount);
                a > n.maxFileCount && n._resetPreviewThumbs(s)
            } else !s || f ? (n._resetPreviewThumbs(!1), f && n.clearStack()) : !s || 0 !== p || n.previewCache.count() && !n.overwriteInitial || n._resetPreviewThumbs(!0);
            n.isPreviewable ? n.readFiles(d) : n._updateFileDetails(1), n._showFolderError(m)
        }, _abort: function (t) {
            var i, a = this;
            ...
            r.loadedImages = [], r.totalImagesCount = 0, e.each(i, function (e, t) {
                ...
                var T, E, S, k, F, P, I, A, D, z, $, j, U = v + x, B = u + "-" + U, O = i[x], R = m.text, L = m.image,
                ...
                return 0 !== W || t.isEmpty(w) || !t.isArray(w) || t.isEmpty(H) || (F = t.compare(Z, H), W += t.isEmpty(F) ? 0 : F.length, 0 !== W) ? r.showPreview ? !C && N > b ? (r.addToStack(O), s.addClass("file-thumb-loading"), r._previewDefault(O, B), r._initFileActions(), r._updateFileDetails(f), void a(x + 1)) : (o.length && void 0 !== FileReader ? (D = R(O.type, Z), z = M(O.type, Z), $ = L(O.type, Z), d.html(c.replace("{index}", x + 1).replace("{files}", f)), s.addClass("file-thumb-loading"), l.onerror = function (e) {
                    ...
                    if (n = {name: Z, type: O.type}, e.each(m, function (e, t) {
                        ...
                        if (a = p.join("").toLowerCase().substring(0, 8), c = t.getMimeType(a, "", ""), t.isEmpty(c) && (d = t.arrayBuffer2String(l.result), c = t.isSvg(d) ? "image/svg+xml" : t.getMimeType(a, d, O.type)), n = {
                                name: Z,
                                type: c
                            }, D = R(c, ""), z = M(c, ""), $ = L(c, ""), j = D || z, j || $) return void u(j)
                    }
